...
| 18/9 · **CP5** | Dựng slide 6 trang để xuất PDF (`demo-slides.html` → `demo-slides.pdf`) · kịch bản quay video demo dự phòng (`demo-video-script.md`) · bộ dụng cụ vòng dùng thử R6 (`validation/`) | Yêu cầu mốc CP5: slide PDF + video dự phòng, và R6 làm tại mốc này. Slide **không** thêm số liệu mới — mọi con số trỏ về §1, §5, §7; chuẩn "đạt" ở §7 giữ nguyên như đã khoá tại CP4 |
| 18/9 · **CP5 · sau vòng dùng thử** | **Sửa cách thu biên bản dùng thử** trước khi chạy 3 người còn lại: tách ô *"câu bạn vừa gõ"* khỏi ô *"lời người thử nói"*, thêm ô *"đường đi bot rơi vào"* và 1 ảnh chụp màn hình mỗi task ([`validation/README.md`](validation/README.md) §3) | Hai biên bản đầu (Ngô Văn Giáp 19:32, Mai Văn Trung 19:35) ghi *nhiệm vụ* một đằng, *câu đã gõ* một nẻo → **không truy được** người thử đã đi qua nhánh nào, nên không dùng để kết luận về nhánh low-confidence. Chi tiết: [`validation/user_testing_log.md`](validation/user_testing_log.md) |
| 18/9 · **CP5 · sau vòng dùng thử** | **Giữ nguyên** nhánh `NOGROUND` và `τ_thấp` = 0.45 — không nới ngưỡng để bot "cố trả lời" câu ngoài kho nguồn | **2/2** câu người thật tự gõ (*"Phòng E402 mở cửa từ lúc mấy giờ?"* — gần như trùng câu thử `G16`; *"VinUni đóng cửa lúc mấy giờ?"*) đều ngoài kho nguồn 7 mẩu → **theo thiết kế phải rơi nhánh từ chối** (biên bản chưa ghi nhãn đường đi nên đây là suy ra, xem thay đổi trên), mà cả hai người vẫn nói *"Tin, nhưng có nêu lý do / điều kiện"* và *"Có — tự tra cứu lại dễ dàng"*. Đây là bằng chứng người thật cho quyết định đã khoá ở §10 mục 5 |
| 18/9 · **CP5 · sau vòng dùng thử** | **Đã quyết, chưa làm:** chỉ báo chờ có bước + đếm giây thay dòng chữ tĩnh trong `send()` của bản mẫu | *"Ngồi đợi vài giây (chờ tải)"* — Mai Văn Trung, T1. Độ trễ ~8041 ms/câu là của API Groq, không sửa được; thứ sửa được là cho người dùng biết máy đang chạy tới bước nào. **Nếu không kịp trước 22:30 thì khai là chưa làm** |
